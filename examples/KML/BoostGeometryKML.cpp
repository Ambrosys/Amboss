...
{
    Folder folder;
    folder.add( Point( 13.33 , 45.12 ) , "Point" );
    folder.add( Box( Point( 13.33 , 45.13 ) , Point( 13.35 , 45.14 ) ) , "Box" );
    folder.add( Segment( Point( 13.33 , 45.13 ) , Point( 13.35 , 45.14 ) ) , "Segment" );
